        ...
        function setLoadingDisplay () {
            ...
            cc.loader.onProgress = function (completedCount, totalCount, item) {
                ...
                if (progressBar && percent != 100) {
                    ...
                    var element = document.getElementsByClassName("suggestionText");
					if(percent > 90)
                        element[0].innerHTML  = "Congratulation! Your registration was completed. Are your ready? We're about to send you to match now ..."
                    else if(percent > 80)
                        element[0].innerHTML  = "Almost done!"
                    else if(percent > 60)
                        element[0].innerHTML  = "This registering will only take time at first loading ..."
                    else if(percent > 40)
                        element[0].innerHTML  = "Registration successful!! International Cup is on the way ..."
                    else if(percent > 30)
                        element[0].innerHTML  = "It will take a bit time, please wait ..."
                    else if(percent > 20)        
                        element[0].innerHTML  = "Your profile are ready!! Registration on Continent Cup ..."
					
					
					
					cc.log(element[0].innerHTML);
                }
            };
